...
<div class="shade">
<h5><?php echo $i_message['php_os'];?>&nbsp;&nbsp;<span class="p"><?php echo PHP_OS;result(1, 1);?></span></h5>
...
<p class="center">
	...
	<input style="width:200px;" type="submit" class="submit" value="<?php echo $i_message['install_next'];?>" <?php if($quit) echo "disabled=\"disabled\"";?>>
	</form>
</p>
<?php
}
